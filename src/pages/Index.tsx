...
import { Search, MapPin, ArrowRight, Shield, Users, Clock, CheckCircle, Loader2 } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Cari barang hilang Anda dengan filter kategori, lokasi, dan tanggal yang lengkap.',
    },
    {
      icon: Shield,
      title: 'Aman & Terpercaya',
      description: 'Data Anda terlindungi dan proses klaim dilakukan dengan verifikasi yang aman.',
    },
    {
      icon: MapPin,
      title: 'Jangkauan Luas',
      description: 'Layanan tersedia di berbagai kota besar di seluruh Indonesia.',
    },
  ];
        ...
        <div className="container relative mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Platform terpercaya untuk melaporkan barang hilang dan membantu mengembalikan barang temuan kepada pemiliknya yang sah.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Platform Lost & Found yang mudah digunakan, aman, dan memiliki jangkauan luas di seluruh Indonesia.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Jangan khawatir! Segera laporkan barang Anda yang hilang dan biarkan komunitas kami membantu menemukannya.
          </p>
          <Link to="/report-lost">
            <Button
              variant="secondary"
